...
class Persian_Elementor_Templates_Source extends
  Elementor\TemplateLibrary\Source_Base
{
  ...
  {
    $url =
      "https://c204025.parspack.net/c204025/library/persian-elementor/info.json";
  ...
  public function get_data(array $args, $context = "display")
  {
    ...
    $url =
      "https://c204025.parspack.net/c204025/library/persian-elementor/templates/" .
      $filename .
      ".json";
    $response = wp_remote_get($url, ["timeout" => 60]);
    $body = wp_remote_retrieve_body($response);
    ...
    $result["content"] = $this->process_export_import_content(
      $result["content"],
      "on_import"
    );
