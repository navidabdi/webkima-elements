(function () {
...
})()(
  {
          ...
          function customCSS() {
            ...
            if (pageCSS) {
              ...
              elementor.settings.page
                .getControlsCSS()
                .elements.$stylesheetElement.append(pageCSS);
            }
          }
        ...
        var Templates = function Templates() {
          ...
          function goProButton() {
            elementor.hooks.addFilter(
              ...
              function (viewId, data) {
                ...
                if (
                  String(data.template_id).substr(0, ravenId.length) ===
                    ravenId &&
                  !data.templatePro
                ) {
          ...
          function init() {
            elementor.on("document:loaded", function () {
              ...
              if ($e.components.get("library").hasTab("templates/webkima")) {
                return;
              } // eslint-disable-next-line no-undef
    ...
    3: [
      function (require, module, exports) {
        ...
        var Checkbox = elementor.modules.controls.BaseData.extend({
          ui: function ui() {
            var ui = elementor.modules.controls.BaseData.prototype.ui.apply(
              this,
              arguments,
            );
      ...
      function (require, module, exports) {
        ...
        var FileUploader = elementor.modules.controls.BaseMultiple.extend({
          ui: function ui() {
            ...
            ui.fileUploaderSizeWarning =
              ".raven-control-file-uploader-warning-size";
            return ui;
          },
            ...
            jQuery.ajax(this.ui.fileUploaderInput.data("ajax-url"), {
              ...
              success: function success(res) {
                if (res.success) {
                  ...
                  self.ui.fileUploaderWarning
                    .find("ul")
                    .append('<li class="error">'.concat(res.data, "</li>"));
              ...
              error: function error() {
                ...
                self.ui.fileUploaderWarning
                  .find("ul")
                  .append(
                    '<li class="error">Something went wrong please try again.</li>',
                  );
                self.ui.fileUploaderWarning.show();
                self.showUploadBtn();
              },
          ...
          checkFileSize: function checkFileSize(file) {
            var uploadLimit = parseFloat(
              this.ui.fileUploaderInput.data("max-upload-limit"),
            );
          ...
          showFile: function showFile(filename) {
            ...
            this.ui.fileUploaderValue
              .find("> span:first-child")
              .attr("title", filename)
              .text(this.shortenFilename(filename));
          ...
          onRender: function onRender() {
            _.extend(
              elementor.modules.controls.BaseMultiple.prototype.onRender.apply(
                this,
                arguments,
              ),
            );
        ...
        var Presets = elementor.modules.controls.BaseData.extend({
          ...
          onReady: function onReady() {
            ...
            elementor.channels.data.bind(
              "raven:element:after:reset:style",
          ...
          onPresetClick: function onPresetClick(e) {
            ...
            $preset
              .siblings(".raven-element-presets-item")
              .removeClass("active");
            ...
            for (var setting in preset.widget.settings) {
              ...
              if (control.is_repeater) {
                ...
                settings[setting] = new window.Backbone.Collection(
                  preset.widget.settings[setting],
                  {
          ...
          createRepeaterItemModel: function createRepeaterItemModel(
            attrs,
            options,
            controlView,
          ) {
          ...
          getPresets: function getPresets() {
            ...
            return (
              window.ravenPresets[
                this.elementSettingsModel.get("widgetType")
              ] || []
            );
          },
          setPresets: function setPresets(presets) {
            window.ravenPresets[this.elementSettingsModel.get("widgetType")] =
              presets;
          },
    ...
    7: [
      function (require, module, exports) {
        ...
        var Query = elementor.modules.controls.Select2.extend({
          ...
          onReady: function onReady() {
            setTimeout(
              elementor.modules.controls.Select2.prototype.onReady.apply(
                this,
                arguments,
              ),
            );
          ...
          var RavenEditor = function RavenEditor() {
            ...
            function setWidgetsDarkIcon(value) {
              if (typeof elementor.settings.editorPreferences !== "undefined") {
                $("#elementor-editor-wrapper").removeClass(
                  "raven-icon-theme-dark raven-icon-theme-light raven-icon-theme-auto",
                );
                var uiTheme =
                  typeof value !== "undefined"
                    ? value.attributes.ui_theme
                    : elementor.settings.editorPreferences.model.get(
                        "ui_theme",
                      );
                $("#elementor-editor-wrapper").addClass(
                  "raven-icon-theme-" + uiTheme,
                );
              }
            }
    ...
    9: [
        ...
        var Form = _module["default"].extend({
          ...
          updateFieldMapping: function updateFieldMapping() {
            ...
            _.each(self.fields, function (field, fieldKey) {
              ...
              var options = {};
              var fieldItems = self.getRepeaterItemsByLabel(
                "fields",
                field.filter,
              );
          ...
          getRepeaterItemsByLabel: function getRepeaterItemsByLabel(
            propertyName,
            filter,
          ) {
            var items = {};
      ...
      { "./module": 10, "@babel/runtime/helpers/interopRequireDefault": 18 },
    ],
    10: [
      function (require, module, exports) {
        "use strict";
        ...
        var Module = elementorModules.editor.utils.Module.extend({
          ...
          getControlView: function getControlView(propertyName) {
            ...
            var view = this.panel
              .getCurrentPageView()
              .children.findByModelCid(control.cid);
            return view;
          },
          ...
          addControlSpinner: function addControlSpinner(name) {
            ...
            if (
              $input.attr("disabled") ||
              $el.find(".elementor-control-spinner").length > 0
            ) {
              return;
            }
          ...
          getElementSettings: function getElementSettings(model, name) {
            ...
            return value instanceof window.Backbone.Collection
              ? value.toJSON()
              : value;
          },
        });
    ...
    11: [
        ...
        function _default(panel, model, view) {
          var Categories = _module["default"].extend({
            ...
            onElementChange: function onElementChange(propertyName) {
              ...
              var specificCategoriesControl = this.getControlView(
                "specific_categories",
              );
      ...
      {
        "../utils/module": 10,
        "@babel/runtime/helpers/interopRequireDefault": 18,
      },
    ],
    12: [
      function (require, module, exports) {
      ...
      function (require, module, exports) {
        ...
        function _default(panel, model, view) {
          var ActiveCampaign = _form["default"].extend({
            ...
            remoteFields: [],
            onSectionActivated: function onSectionActivated(
              activeSection,
              section,
            ) {
              var _this = this;
              ...
              this.updateList({
                activecampaign_api_key_source:
                  this.getControlValue("activecampaign_api_key_source") ||
                  "default",
                activecampaign_api_key: this.getControlValue(
                  "activecampaign_api_key",
                ),
                activecampaign_api_url: this.getControlValue(
                  "activecampaign_api_url",
                ),
              });
              this.getControlView("activecampaign_fields_mapping").on(
                "add:child",
                function () {
            ...
            updateFieldMapping: function updateFieldMapping() {
              ...
              var fieldsMapControlView = this.getControlView(
            ...
            doSuccess: function doSuccess(response) {
              ...
              var options = {};
              var lists = {};
              var activecampaignList = this.getElementSettings(
                this.model,
                "".concat(self.action, "_list"),
              );
            ...
            onElementChange: function onElementChange(setting) {
              if (
                setting === "activecampaign_api_key_source" ||
                setting === "activecampaign_api_key" ||
                setting === "activecampaign_api_url"
              ) {
                this.updateList({
                  activecampaign_api_key_source:
                    this.getControlValue("activecampaign_api_key_source") ||
        ...
        function _default(panel, model, view) {
          var Email = _form["default"].extend({
            ...
            onSectionActivated: function onSectionActivated(
              ...
              var replyToOptionsControl = this.getControlView(
        ...
        function _default(panel, model, view) {
          var Hubspot = _module["default"].extend({
            ...
            onInit: function onInit() {
              elementor.channels.editor.on(
                "section:activated",
                this.onSectionActivated.bind(this),
              );
            },
            onSectionActivated: function onSectionActivated(
              activeSection,
              ...
              this.getControlView("hubspot_mapping").on(
                "add:child",
                function () {
                  _this.updateFieldMapping();
                },
        ...
        function _default(panel, model, view) {
          var Mailchimp = _form["default"].extend({
            ...
            onSectionActivated: function onSectionActivated(
              ...
              this.updateList({
                mailchimp_api_key_source:
                  this.getControlValue("mailchimp_api_key_source") || "default",
                mailchimp_api_key: this.getControlValue("mailchimp_api_key"),
              });
              this.getControlView("mailchimp_fields_mapping").on(
                "add:child",
                function () {
                  _this.updateFieldMapping();
                },
            ...
            doSuccess: function doSuccess(response) {
              ...
              var options = {};
              var lists = {};
              var mailchimpList = this.getElementSettings(
                this.model,
                "".concat(self.action, "_list"),
              );
            ...
            onElementChange: function onElementChange(setting) {
              switch (setting) {
                ...
                case "mailchimp_api_key":
                  ...
                  this.updateList({
                    mailchimp_api_key_source:
                      this.getControlValue("mailchimp_api_key_source") ||
                      "default",
                    mailchimp_api_key:
                      this.getControlValue("mailchimp_api_key"),
                  });
                  break;
            ...
            onListUpdate: function onListUpdate() {
              ...
              wp.ajax.send("raven_form_editor", {
                ...
                success: function success(response) {
                  _this3.updateGroupOptions(
                    response.success[0].list_details.groups,
                  );
