  ...
  EFS::createSection($prefix, [
    ...
    "fields" => [
      ...
      [
        ...
        "text_off"   => __("deactive", "webkima-elements"),
        "subtitle"   => __(
          Base::isElementorInstalled() ? "Activate Font On Elementor Editor" : "برای استفاده از این تنظیم باید افزونه المنتور را نصب داشته باشید.",
          "webkima-elements"
        ),
        "default"    => true,
        "text_width" => 70,
